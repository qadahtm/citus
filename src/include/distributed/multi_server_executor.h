...
typedef enum
{
	...
	MULTI_EXECUTOR_LOCAL = 1,
	MULTI_EXECUTOR_ADAPTIVE = 2,
	MULTI_EXECUTOR_REAL_TIME = 3,
	MULTI_EXECUTOR_TASK_TRACKER = 4,
	MULTI_EXECUTOR_ROUTER = 5,
	MULTI_EXECUTOR_COORDINATOR_INSERT_SELECT = 6
} MultiExecutorType;
